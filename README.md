...
- `screenshots/` — capturas de referência das telas: `01-dashboard`, `02-pipeline`, `03-prospeccao`, `04-clientes-linha-expandida`, `05-automacao`, `06-nova-empresa-validacao`.
- `assets/logo 1.jpeg` — marca "S" usada na sidebar; `assets/manual-identidade-visual.jpeg` — manual de identidade (paleta, tipografia, ícones, versões da marca).
